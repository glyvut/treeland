...
| [ext-foreign-toplevel-image-capture](ext-foreign-toplevel-image-capture-v1/README.md) | E / V | OutputViewport 捕获窗口子树（装饰 + 主 surface + subsurface）；constraints 等于 boundingRect；像素读回与 stop/start 复用 |
